...
<div>
	<h1><s:message code="label.timetableList" /></h1>
		...
		<table class="table table-striped table-bordered">
			<c:if test="${!empty list }">
				<tr>
					...
					<th class="col-md-2"><s:message code="label.courseName" /></th>
					<th class="col-md-2"><s:message code="label.subjectName" /></th>
					<th class="col-md-2"><s:message code="label.day" /></th>
					<th class="col-md-2"><s:message code="label.time" /></th>
				...
				<c:forEach items="${list }" var="timetable" varStatus="ct">
					<tr>
						...
						<td><c:out value="${timetable.facultyName }" /></td>
